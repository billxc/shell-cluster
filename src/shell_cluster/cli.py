...
def start(no_tunnel: bool, name: str | None, port: int | None, no_open: bool, no_dashboard: bool) -> None:
    ...
    daemon = Daemon(config, no_tunnel=no_tunnel, local_port=port, no_open=no_open, no_dashboard=no_dashboard or not config.node.dashboard)
    try:
